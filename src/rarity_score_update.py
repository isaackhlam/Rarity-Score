...
class MANIFOLD(object):
	@torch.no_grad()
	def __init__(self, real_features, metric = 'euclidian', device = 'cpu'):
		...
		print('Pre-processing pairwise distances ...')
