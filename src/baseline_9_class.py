...
if __name__ == '__main__':
    ...
    for i in range(0,10):
        ...
        print(f"class {i} is generated image. Others are real manifold. Calculating...\n")
        data_test = CIFAR10Dataset(data, partition=[i])
        ...
        np.savetxt(f'./result/9_class_against_remain/remain_{i}.txt', score)
